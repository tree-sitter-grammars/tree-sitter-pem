...
HOMEPAGE_URL := https://github.com/tree-sitter-grammars/tree-sitter-pem
VERSION := 0.3.0
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/pem '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/pem
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/pem
