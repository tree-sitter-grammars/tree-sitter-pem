...
enum {
  ...
  sym_footer = 10,
  sym_data = 11,
  aux_sym_pem_repeat1 = 12,
  aux_sym_data_repeat1 = 13,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [36] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_footer, 4),
  [38] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_footer, 4),
  ...
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_header, 4),
